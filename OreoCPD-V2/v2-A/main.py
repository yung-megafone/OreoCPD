...
def main(data, addr, ctrl):
    ...
    if data > 0:  # NEC protocol sends repeat codes.
        ...
        # Print remote data codes (for debugging)
#           print('Data {:02x} Addr {:04x}'.format(data, addr))
    ...
    if data == 22:		# button 1 // Econobox
        profiles.pro_1()
    elif data == 25:	# button 2 // Daily
        profiles.pro_2()
...
# Basically waits for a proper signal from the NEC protocol on pin 15 and calls main
